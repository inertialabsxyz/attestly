...
attestation verifies via awp-core-py (the same path the static audit
...
# Import awp-core-py via its C-extension submodule — see sinks.py rationale.
from awp._native import AgentIdentity, verify_attestation  # noqa: E402

pytest.importorskip("langgraph")

from langgraph.graph import END, START, StateGraph  # noqa: E402

from awp.langgraph import CallableSink, FileSink, attest  # noqa: E402
...
def test_every_emitted_attestation_verifies(tmp_path) -> None:
    """Every emitted attestation must verify via awp-core-py — the exact
