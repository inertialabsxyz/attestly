...
at https://attestly.xyz/quickstart.
...
Run it::
    ...
    ATTESTLY_API_KEY=<your key> python python/attestly-langgraph/examples/quickstart_snippet.py

With ``ATTESTLY_API_KEY`` set it ships attestations to Attestly Cloud via
...
def main() -> None:
    ...
    from attestly.langgraph import CloudSink, FileSink, attest
    ...
    if api_key:
        print("Signed attestation shipped to Attestly Cloud — check your dashboard.")
    else:
        print(
            "ATTESTLY_API_KEY unset — signed attestation written to "
