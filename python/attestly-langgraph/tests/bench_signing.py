...
``attestly-core-py``, which does the Ed25519 work in Rust; the realistic Python-
side cost is dict construction + the FFI hop. Measure rather than assume.

Run with::

    pytest python/attestly-langgraph/tests/bench_signing.py -v -s
...
# package shared with the SDK. See attestly/langgraph/sinks.py for the rationale.
from attestly._native import AgentIdentity, sign_attestation, verify_attestation
