...
//!
//! 1. Computes leaf hashes via `awp_core::attestation_leaf_hash`
...
/// Default batcher configuration from `planning/awp-prototype-plan.md`
...
mod tests {
    use super::*;
    use awp_core::{sha256, AgentKeypair, AttestationStatus};
