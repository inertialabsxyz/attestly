//! Merkle batching primitives for Attestly attestations.
//!
...
//! `planning/attestly-prototype-plan.md` → "Weeks 5-6: Attestation Batching".
//!
//! ## Leaf-hash binding
//!
...
/// phase deferred to Phase 2 of Attestly overall. Phase 3 always writes them as
/// `None` / `NULL`.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct Batch {
    pub id: Uuid,
...
/// rootless batch is meaningless to Attestly.
