//! `Attestation` — the unit of signed work in Attestly.
//!
...
//! `planning/attestly-prototype-plan.md` exactly; trace/zk fields from
...
/// is the canonical multi-attestation format for Attestly's append-only log.
