...
//!
//! Drives the state machine described in `planning/attestly-prototype-plan.md`
//! → "Coordination State":
//!
...
//! `data/attestations.json`. See `attestly-core::execution` for the join
//! semantics.
...
mod tests {
    ...
    use attestly_core::{load_executions, sha256, AgentKeypair, Attestation};
