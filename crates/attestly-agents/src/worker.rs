...
//! risk-mitigation row "Minimal framework coupling in attestly-core", Worker and
...
impl Worker {
    ...
    /// identity. Pair with [`attestly_core::AgentIdentity::load_or_create`] +
    /// [`attestly_core::FileIdentityStore`] for cross-restart stability.
