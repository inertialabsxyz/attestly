...
- **Body:** summarise what changed (bullet points from the commits) and reference the relevant planning doc phase (e.g. _Implements Phase 1 — Organisation Model, `planning/v2-plan.md`_)
