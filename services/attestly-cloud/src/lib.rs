//! `attestly-cloud` — hosted Attestly ingest, search, and share-link service.
//!
...
//!   using `attestly-core`. The same code path runs at ingest **and** at retrieval
...
//!
//! ```ignore
//! use attestly_cloud::{router, AppState};
//! use std::sync::Arc;
//!
